...
|success_action_status|数值|指定了上传文件成功时返回的状态码，前提是success_action_redirect 没有被指定，如果值为200或204，OSS返回内容为空。如果值为201，则返回的状态码为201，http body 内容为xml格式的object相关信息<br>默认值：204<br>有效值：200，201，204（默认）无|否|
