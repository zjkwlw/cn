...
您可以通过 JMR 控制台快速创建集群。
关于JMR的计费说明请参见：[价格总览](https://github.com/jdcloudcom/cn/blob/master/documentation/Cloud-Database-and-Cache/MongoDB/Pricing/Pricing.md)、[计费说明](https://github.com/jdcloudcom/cn/blob/master/documentation/Cloud-Database-and-Cache/MongoDB/Pricing/billing-instructions.md)，本文介绍通过控制台创建JMR集群。
...
## 操作步骤
1. 登录 [JMR 控制台](https://mongodb-console.jdcloud.com/mongodb)，选择地域。
...
2. 在集群管理页面，点击“创建”，进入创建页面。
	...
	4. 基本信息
	  ...
	  ![基本信息](https://github.com/jdcloudcom/cn/blob/master/image/mongodb/mongo-003.png)
