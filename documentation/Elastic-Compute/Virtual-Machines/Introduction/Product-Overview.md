...
京东云也提供了API接口方便您管理云主机，有关云主机API操作的详细信息，请参见[OpenAPI文档](http://docs.jdcloud.com/cn/api/virtual-machines/overview)。您可以使用SDK（支持 Java/Python/Go/Node.js/PHP/.Net/C++）编程或使用京东云云命令行工具（CLI）调用云主机API，具体请参考：[SDK文档](http://docs.jdcloud.com?act=3)及[CLI文档](http://docs.jdcloud.com/cn/cli/introduction)。
